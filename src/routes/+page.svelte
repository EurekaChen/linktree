    ...
    <!-- Your Image Here -->
    <img src="https://arweave.net/8MfM94Fd7MRBeQ9-265gGL-EgqMXE6OINSZx5bAu780" class="avatar" srcset="https://arweave.net/8MfM94Fd7MRBeQ9-265gGL-EgqMXE6OINSZx5bAu780 2x" alt="linktree AR">

    <!-- Title -->
    <h1 role="heading">Link Tree AR</h1>

    <!-- Short Bio -->
    <p>You can directly edit this page and permanently publish it to Arweave, then accessing your page through the ar.io gateway</p>
    ...
    -->
       ...
       <!-- Generic Website -->
      <a class="button button-default" href="https://linktree.ar.io" target="_blank" rel="noopener" role="button"><img class="icon" aria-hidden="true" src="images/icons/generic-website.svg" alt="Website Icon">Visit Website</a><br>

    <!-- GitHub -->
    <a class="button button-github" href="https://github.com/eurekachen" target="_blank" rel="noopener" role="button"><img class="icon" aria-hidden="true" src="images/icons/github.svg" alt="GitHub Logo">GitHub</a><br>
    ...
    -->
    <p>Publish this page to <a href="https://arweave.net" target="_blank" rel="noopener" role="button">Arweave</a>.</p>
